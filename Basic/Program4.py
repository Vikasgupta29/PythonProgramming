...
That is, write a python function translate() that accepts the bilingual dictionary and a list of English words and returns a list of equivalent Swedish words. 
"""
